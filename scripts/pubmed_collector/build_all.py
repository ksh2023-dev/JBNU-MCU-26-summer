...
#
# 자동 거부로 쓰지 않는 이유(2026-08-21 시뮬레이션): 현재 수집 1,132편에 적용하면 27편이
# 걸리는데, 전건 대조 결과 **진짜 오귀속 10편 · 판정 보류 1편 · 오탐(정상) 16편**이었다.
# 즉 정밀도가 10/27 ≈ 37%다 — 오귀속 10편을 지우자고 정상 16편을 함께 버리게 된다.
